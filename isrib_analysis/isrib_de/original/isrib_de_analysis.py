...
dir = '/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/original/'

check_data = pd.read_csv(str(dir) + 'ISRIBxpresspipe_thresholded_counts.txt', sep='\t', index_col=0)
check_list = check_data.index.tolist()

# Import DESeq2 TE data
tm_data = pd.read_csv(str(dir) + 'tm_counts_diffx.tsv', sep='\t')
tmisrib_data = pd.read_csv(str(dir) + 'tmisrib_counts_diffx.tsv', sep='\t')
isrib_data = pd.read_csv(str(dir) + 'isrib_counts_diffx.tsv', sep='\t')
...
tm_ribo_data = pd.read_csv(str(dir) + 'tm_ribo_counts_diffx.tsv', sep='\t')
tm_rna_data = pd.read_csv(str(dir) + 'tm_rna_counts_diffx.tsv', sep='\t')

tmisrib_ribo_data = pd.read_csv(str(dir) + 'tmisrib_ribo_counts_diffx.tsv', sep='\t')
tmisrib_rna_data = pd.read_csv(str(dir) + 'tmisrib_rna_counts_diffx.tsv', sep='\t')

isrib_ribo_data = pd.read_csv(str(dir) + 'isrib_ribo_counts_diffx.tsv', sep='\t')
isrib_rna_data = pd.read_csv(str(dir) + 'isrib_rna_counts_diffx.tsv', sep='\t')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/tm_deseq2_venn.png', dpi=3600, bbox_inches='tight')
...
jordan_tmisrib = ['KCNQ2', 'DNHD1', 'FLNC']
plt.title("Tm + ISRIB", fontsize = 28)
c = venn2([set(jordan_tmisrib), set(tmisrib_common)], set_labels = ('This paper', 'Original paper'))
c.get_patch_by_id('10').set_color('#d95f02')
c.get_patch_by_id('01').set_color('#7570b3')
c.get_patch_by_id('10').set_edgecolor('black')
c.get_patch_by_id('01').set_edgecolor('black')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/tm_isrib_deseq2_venn.png', dpi=3600, bbox_inches='tight')
...
c = venn2([set(jordan_isrib), set(isrib_common)], set_labels = ('This paper', 'Original paper'))
c.get_patch_by_id('10').set_color('#d95f02')
c.get_patch_by_id('01').set_color('#7570b3')
c.get_patch_by_id('10').set_edgecolor('black')
c.get_patch_by_id('01').set_edgecolor('black')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/isrib_deseq2_venn.png', dpi=3600, bbox_inches='tight')
...
c = venn2(
    ...
    set_labels = ('DESeq2', 'DESeq1'))
c.get_patch_by_id('10').set_color('#7570b3')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/tm_deseq_Ingolia_comp_venn.png', dpi=3600, bbox_inches='tight')
...
plt.title("Tm + ISRIB", fontsize = 28)
c = venn2(
    [set(tmisrib_common), set(ingolia_tmisrib)],
    set_labels = ('DESeq2', 'DESeq1'))
c.get_patch_by_id('10').set_color('#7570b3')
c.get_patch_by_id('01').set_color('#1b9e77')
c.get_patch_by_id('10').set_edgecolor('black')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/tmisrib_deseq_Ingolia_comp_venn.png', dpi=3600, bbox_inches='tight')
...
plt.title("ISRIB", fontsize = 28)
c = venn2(
    [set(isrib_common), set(ingolia_isrib)],
    set_labels = ('DESeq2', 'DESeq1'))
c.get_patch_by_id('10').set_color('#7570b3')
c.get_patch_by_id('01').set_color('#1b9e77')
c.get_patch_by_id('10').set_edgecolor('black')
...
try:
    ...
    pass
plt.savefig('/Users/jordan/Desktop/xpressyourself_manuscript/isrib_analysis/isrib_de/plots/isrib_deseq_Ingolia_comp_venn.png', dpi=3600, bbox_inches='tight')
