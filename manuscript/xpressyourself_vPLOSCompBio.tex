...
\textbf{Process} & \textbf{Command} & \textbf{Wallclock Time} & \textbf{Max RAM}\\
  ...
  \hline
  Read Quantification & \texttt{count -c htseq} & 04h 13m 04s & 0.16 GB \\
  \hline
  Isoform Abundance & \texttt{count -c cufflinks} & 01h 09m 32s & 2.36 GB \\
  \hline
  Differential Expression (n=9) & \texttt{diffxpress} & 00h 07m 50s & 0.65 GB \\
  \hline
  Read Distributions & \texttt{readDistribution} & 00h 06m 19s & 0.28 GB \\
  \hline
  ...
  \hline
  Library Complexity & \texttt{complexity} & 00h 48m 46s & 1.98 GB \\
  \hline
  rRNA probe & \texttt{rrnaProbe} & 00h 00m 55s & 0.15 GB \\
  \hline
  Data Transfer + Pipeline & \texttt{riboseq} &  & \\
  \hline
  & & & \\
  \hline
  \hline
