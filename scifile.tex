...
\title{XPRESSyourself: Democratizing High-Throughput Genomics}
...
\author
  \parbox{\linewidth}{\centering
    {Jordan A. Berg,$^{1}$
    Jonathan R. Belyeu,$^{2,3}$
    Alex J. Bott,$^{1}$
    Jason Gertz,$^{4}
    Michael T. Howard,$^{2},
    Aaron R Quinlan,$^{2,3,5}$
    Jared P. Rutter$^{1,6\ast}$\\
\\
\normalsize{$^{1}$Department of Biochemistry, School of Medicine, University of Utah, Salt Lake City, UT, USA}\\
\normalsize{$^{2}$Department of Human Genetics, University of Utah, Salt Lake City, UT, USA}\\
\normalsize{$^{3}$USTAR Center for Genetic Discovery, University of Utah, Salt Lake City, UT, USA}\\
\normalsize{$^{4}$Department of Oncological Sciences, University of Utah, Salt Lake City, UT, USA}\\
\normalsize{$^{5}$Department of Biomedical Informatics, University of Utah, Salt Lake City, UT, USA}\\
\normalsize{$^{6}$Howard Hughes Medical Institute, University of Utah, Salt Lake City, UT, USA}\\
